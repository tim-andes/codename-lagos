...
The goal of this repo is to provide users with the ability to analyze declassified NHI/UAP documents with GenerativeAI.
...
```
git clone https://github.com/tim-andes/codename-lagos.git
```
